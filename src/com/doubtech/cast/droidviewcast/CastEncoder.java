package com.doubtech.cast.droidviewcast;
...
public class CastEncoder {
     ...
     */
    public CastEncoder() throws InvalidClassException {
        // QVGA at 2Mbps
        mWidth = 1920;
        mHeight = 1080;
        mBitRate = 4800;
        ...
        if(Build.VERSION.SDK_INT >= 18) {
        	...
        	throw new InvalidClassException("Must use SDK >= 18 to use CastEncoder");
        }
    }
    ...
    public void writeFrame(Bitmap frame) {
    	if(null != mSurface) {
    		for(int i = 0; i < 15; i++) {
		    	drainEncoder(false);
		        Canvas canvas = mSurface.lockCanvas(new Rect(0, 0, mWidth, mHeight));
		        Paint p = new Paint();
